...
# In diesem Block geht es um die Grundlagen der Programmierung mit Base R.
...
# Die Entwicklungsumgebung RStudio wird in Block 2 vorgestellt, siehe
# block02_rstudio_setup/rstudio_kennenlernen.R
