...
* Variablen anlegen und benennen
* Verstehen, warum R nicht Excel ist
* Datenklassen unterscheiden: character, numeric, logical, factor, Date, data.frame, list
* Mit Datumsangaben umgehen
